...
import { Terminal, ArrowRight, Sparkles, Zap } from "lucide-react";
    ...
    <div className="flex flex-col">
      ...
      <section className="container mx-auto px-4 pt-20 pb-12 text-center">
        ...
        <p className="text-lg md:text-xl text-muted max-w-2xl mx-auto mb-8">
          Omega Platform — AI Copilot, deployment pipelines, and infrastructure monitoring.
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-2xl mx-auto rounded-xl border border-border bg-card p-8 glow-cyan">
          <h2 className="text-2xl font-bold mb-4">Ready to build with Omega?</h2>
          <p className="text-muted mb-6">
            AI tools, deployment, and monitoring — in one platform.
